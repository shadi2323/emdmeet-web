        ...
        <div className="relative z-10 max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-24 sm:py-32">
          <div className="text-center">
            ...
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-white leading-tight mb-6">
              EMDmeet is a service provider that facilitates high-quality offline one-on-one face-to-face social connections.
            </h1>
            <p className="text-xl sm:text-2xl text-white/90 max-w-4xl mx-auto mb-8 leading-relaxed">
              We invite or accept applications from people in selected Canadian regions, verify real identities, review applicant quality, and help facilitate meaningful in-person social meetings through a structured matching process.
            </p>
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-white rounded-2xl p-8 shadow-sm border border-slate-200 hover:shadow-lg transition-all">
              ...
              <h3 className="text-xl font-semibold text-slate-900 mb-3">Real-person review</h3>
            ...
            <div className="bg-white rounded-2xl p-8 shadow-sm border border-slate-200 hover:shadow-lg transition-all">
              ...
              <h3 className="text-xl font-semibold text-slate-900 mb-3">Anti-no-show mechanism</h3>
              <p className="text-slate-600 leading-relaxed">
